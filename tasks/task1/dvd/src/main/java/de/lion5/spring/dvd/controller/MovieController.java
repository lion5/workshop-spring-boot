...
public class MovieController {
    ...
    public String getMovies(Model model) {
        ...
        // TODO add movies to the view

        // TODO think about what does that mean
        return "movies";
    }

    @PostMapping
    public String processMovie(Movie movie, Errors errors, Model model) {
        // TODO store movie in the movies list
